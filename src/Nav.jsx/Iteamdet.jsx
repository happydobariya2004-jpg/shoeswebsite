...
const Iteamdet = () => {
  ...
  let showData = Aboutdeta.find((v) => v.id == id)
  ...
  return (
      ...
      <div className="container ">
        <div className="row align-items-center">
          ...
          <img
            className="img-fluid rounded-5 m-5"
            src={showData.image}
            style={{ maxWidth: "300px" }}
            alt=""
          />

          <div className="col-12 col-md-6" style={{ marginLeft: "100px" }}>
            <h2 className="fs-6 text-success">{showData.brand}</h2>
            <h2>{showData.details}</h2>

            <h2>₹{showData.price}</h2>
            <h2 style={{ color: "#ff6b2b" }}>{showData.rating}</h2>

            <button className='text-light mb-1 border rounded-1' style={{ background: "#ff6b2b" }}>
              Hot Deal
            </button>

            <h6 className="fs-3">
              <del className='text-danger fs-5'>₹4000</del> ₹{showData.price}
            </h6> 
          ...
          <div className="row mt-5 text-center   ">
            ...
            <div className="col-lg-3 col-sm-4 ">
              ...
              <img className="rounded-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGC169Nn0SR1DYyE2A2wWW7mDaIpnyaSD1Nw&s" alt="" />
              <h6>Blue Casual Sneakers</h6>
              <button className="bt mt-3">view more</button>
            </div>
